...
import { EmbeddedForm2FlowDiagram } from "../EmbeddedForm2FlowDiagram";
      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        ...
        {state.type === "complete" && (
          <>
            ...
            >
              <h2
                className={`mb-3 text-base font-semibold font-sans ${titleClass}`}
              >
            ...
            <details className="mt-6">
              <summary
                className={`cursor-pointer select-none font-medium ${secondaryClass}`}
              >
                Embedded Form 2 Flow Diagram
              </summary>
              <div className="mt-3">
                <EmbeddedForm2FlowDiagram />
              </div>
            </details>
            {navLinks}
          </>
...
/**
 * Return page for Embedded Form 2 checkout.
 * Fetches the full Checkout Session and renders it as a formatted tree.
 */
export default function EmbeddedForm2ReturnPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
