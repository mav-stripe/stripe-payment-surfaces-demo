...
/**
 * POST /api/create-embedded-checkout-session
 * Creates a Stripe Checkout Session (embedded UI mode) for "Logo design+" $4.99.
 * Returns client_secret for mounting EmbeddedCheckout.
 */
export async function POST(request: NextRequest) {
  ...
  const returnUrl = `${baseUrl}/embedded-form/return?session_id={CHECKOUT_SESSION_ID}`;
