...
import { EmbeddedFormFlowDiagram } from "../EmbeddedFormFlowDiagram";
          ...
          <>
            ...
            <details className="mt-6">
              <summary className={`cursor-pointer select-none font-medium ${secondaryClass}`}>
                Embedded Form Flow Diagram
              </summary>
              <div className="mt-3">
                <EmbeddedFormFlowDiagram />
              </div>
            </details>
            {navLinks}
          </>
...
/**
 * Return page for Embedded Form checkout.
 * Fetches the full Checkout Session and renders it as a formatted tree.
 */
export default function EmbeddedFormReturnPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
